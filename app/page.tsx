...
export default async function Home() {
  ...
  return <>
    <Header/>
    <main>
      <GiftUnboxing rate={rate} categories={categories||[]}/>
      <section className="store-promises container" aria-label="Shopping with us"><div><span>01 / Transparent pricing</span><p>Know the weight.<br/>Know the making charge.</p></div><div><span>02 / Made for moments</span><p>Everyday rituals.<br/>Extraordinary celebrations.</p></div><div><span>03 / A personal connection</span><p>Real people, ready to help.<br/>Visit us in Eral.</p></div></section>
